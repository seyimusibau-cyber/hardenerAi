                        ...
                        {scanResult && (
                            <div id="scan-report-results" className="mt-12 bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-2xl text-left animate-in fade-in slide-in-from-bottom-4 duration-500">
                                ...
                                <div className="p-6 md:p-8 border-b border-slate-800/80 bg-slate-950/20 grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    {/* Codebase & GitHub Repo Audit */}
                                    <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left py-4">
                                        <h3 className="text-md font-bold text-white mb-2 font-mono flex items-center gap-2">
                                        ...
                                        <p className="text-xs text-slate-400 leading-relaxed mb-4 max-w-[250px]">
                                            Connect your GitHub repository to search source code files (.ts, .py, .go) for leaked API keys, AST flaws, and logical bypasses.
                                        </p>
                                        <Link href="/signup" className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-bold transition-all w-full md:w-auto justify-center shadow-lg shadow-emerald-500/10">
